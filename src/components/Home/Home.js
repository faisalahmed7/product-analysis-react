        ...
        <div className='mb-20'>
            <div className='flex justify-between mt-16 mb-20'>
                <div className="product-details ml-20 w-1/2">
                    <h3 className='text-5xl color ml-20 text-gray-500 font-bold'>Gravity Laptop</h3>
                    <p className='text-xl ml-20 py-8 text-justify'>The laptop drawing tablet is a very useful piece of hardware.
                    ...
                    <div >
                        <button className='text-xl bg-blue-400 rounded-lg border-0 p-2 text-left ml-20'>Show More Details</button>
                    </div>
                </div>
                <div className="img-container w-1/2 ml-16">
